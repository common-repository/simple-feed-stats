<?php // Simple Statistics for Feeds - Show Support Panel

if (!function_exists('add_action')) die();

function simple_feed_stats_wp_resources() {
	
	$plugin_project = '<abbr title="Simple Statistics for Feeds">'. esc_html__('SFS', 'simple-feed-stats') .'</abbr>';
	...
	$title2 = esc_html__('Plugin Planet: Pro WordPress Plugins', 'simple-feed-stats');
	$title3 = esc_html__('Donate via PayPal, credit card, or cryptocurrency', 'simple-feed-stats');
	...
	<div id="project-wrap">
		...
		<div class="project-blurb">
			<p><strong><?php esc_html_e('Please Donate', 'simple-feed-stats'); ?></strong></p>
			<p><?php echo $donate; ?></p>
			<ul>
				<li><a target="_blank" rel="noopener noreferrer" href="<?php echo $url3; ?>" title="<?php echo $title3; ?>"><?php esc_html_e('Make a donation&nbsp;&raquo;', 'simple-feed-stats'); ?></a></li>
			</ul>
		</div>
	</div>
...
simple_feed_stats_wp_resources();